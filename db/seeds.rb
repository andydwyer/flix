...
Review.create!([
  {
    name: "Larry",
    stars: 4,
    comment: "This movie was ok I guess lmao.",
    movie_id: 2
  },
  {
    name: "Jimbo Jones",
    stars: 1,
    comment: "The main character basically invincible. This makes no sense.",
    movie_id: 2
  },
  {
    name: "Ralph Wiggum",
    stars: 5,
    comment: "So good! I want to see it literally one million more times.",
    movie_id: 4
  },
  {
    name: "Rick Sanchez",
    stars: 3,
    comment: "It's good enough to watch in a movie theatre.",
    movie_id: 6
  },
  {
    name: "Annabelle Alaska",
    stars: 1,
    comment: "Please just make it stop!!!!",
    movie_id: 6
  },
  {
    name: "Charlie Jumanji",
    stars: 5,
    comment: "An absolutely positively fantastic film :)",
    movie_id: 7
  }
])